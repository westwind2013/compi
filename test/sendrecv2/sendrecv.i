...
# 197 "/home/westwind/myInstall/crest.mpi/bin/../include/crest.h"
...
int main(int argc, char *argv[])
{
 ...
 if (rank == 0) {
  ...
  if (b == 8) {
   ...
   dest = 1;
   source = 1;
   rc = MPI_Send(&outmsg, 1, ((MPI_Datatype)0x4c000101), dest, tag, ((MPI_Comm)0x44000000));
   rc = MPI_Recv(&inmsg, 1, ((MPI_Datatype)0x4c000101), source, tag, ((MPI_Comm)0x44000000), &Stat);
  } else {
   printf("not 8\n");
  }
 ...
 rc = MPI_Get_count(&Stat, ((MPI_Datatype)0x4c000101), &count);
