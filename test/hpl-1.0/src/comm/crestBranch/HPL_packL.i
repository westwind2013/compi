...
{
# 102 "../HPL_packL.c"
   MPI_Datatype * type = ((void *)0);
   void * * * bufs = ((void *)0);
   double * A;
   int * blen = ((void *)0);
   MPI_Aint * disp = ((void *)0);
   int curr, i, i1, ibuf, ierr=0, j1,
...
# 133 "../HPL_packL.c"
   ...
   if( ( bufs != ((void *)0) ) && ( blen != ((void *)0) ) &&
       ( disp != ((void *)0) ) && ( type != ((void *)0) ) )
   {
      ...
      if( ( m > 0 ) && ( ibuf < jbm ) )
      {
         ...
         {
            lda = PANEL->lda;
            if( curr != 0 ) { A = ( (PANEL->A) + (jb) + (-jb)*(lda) ); }
            else { A = ( (PANEL->A) + (0) + (-jb)*(lda) ); }
         }
         ...
         bufs[nbufs] = (void *)(( (A) + (i1) + (j1)*(lda) ));
         type[nbufs] = ((MPI_Datatype)0x4c00080b);
         blen[nbufs] = m1;
         if( ierr == 0 )
