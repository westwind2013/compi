...
# 154 "../HPL_pdlaswp01T.c"
   ...
   HPL_spreadT( PBCST, IFLAG, PANEL, HplRight, n, U, n, 0, iplen,
                ipmap, ipmapm1 );
   ...
   {
      k = ipmapm1[myrow];
      HPL_dlaswp06T( iplen[k+1]-iplen[k], n, A, lda, ( (U) + (0) + (iplen[k])*(n) )
                                    , n, lindxA );
   }
   ...
   if( equil != 0 )
      HPL_equil( PBCST, IFLAG, PANEL, HplTrans, n, U, n, iplen, ipmap,
                 ipmapm1, iwork );



   HPL_rollT( PBCST, IFLAG, PANEL, n, U, n, iplen, ipmap, ipmapm1 );



   HPL_dlaswp10N( n, jb, U, n, permU );
