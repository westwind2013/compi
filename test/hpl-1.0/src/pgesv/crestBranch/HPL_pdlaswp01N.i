...
# 68 "../HPL_pdlaswp01N.c"
{
# 117 "../HPL_pdlaswp01N.c"
   double * A, * U;
   int * ipID, * iplen, * ipmap, * ipmapm1,
                             * iwork, * lindxA = ((void *)0), * lindxAU,
                             * permU;
   static int equil=-1;
   ...
   n = PANEL->n; n = ( ( (NN) < (n) ) ? (NN) : (n) ); jb = PANEL->jb;
...
# 154 "../HPL_pdlaswp01N.c"
   ...
   if( myrow == icurrow )
   { HPL_dlaswp01N( *ipA, n, A, lda, U, jb, lindxA, lindxAU ); }



   HPL_spreadN( PBCST, IFLAG, PANEL, HplRight, n, U, jb, 0, iplen,
                ipmap, ipmapm1 );
   ...
   {
      k = ipmapm1[myrow];
      HPL_dlaswp06N( iplen[k+1]-iplen[k], n, A, lda, ( (U) + (iplen[k]) + (0)*(jb) )
                             , jb, lindxA );
   }
   ...
   if( equil != 0 )
      HPL_equil( PBCST, IFLAG, PANEL, HplNoTrans, n, U, jb, iplen,
                 ipmap, ipmapm1, iwork );



   HPL_rollN( PBCST, IFLAG, PANEL, n, U, jb, iplen, ipmap, ipmapm1 );



   HPL_dlaswp00N( jb, n, U, jb, permU );
