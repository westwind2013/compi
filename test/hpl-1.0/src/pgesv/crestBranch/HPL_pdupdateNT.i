...
# 181 "../HPL_pdupdateNT.c"
         ...
         cblas_dtrsm( HplColumnMajor, HplLeft, HplLower, HplNoTrans,
...
# 300 "../HPL_pdupdateNT.c"
      while ( test == 2 )
      {
         ...
         cblas_dtrsm( HplColumnMajor, HplRight, HplLower, HplTrans,
