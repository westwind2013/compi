# 1 "../HPL_pdtrsv.c"
# 1 "/home/westwind/mpibench/1hpl/hpl-1.0/src/pgesv/crestBranch//"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 109 "../HPL_pdtrsv.c"
   ...
   double * A=((void *)0), * Aprev=((void *)0), * Aptr, * XC=((void *)0),
                              * XR=((void *)0), * Xd=((void *)0), * Xdprev=((void *)0),
                              * W=((void *)0);
   ...
   Rcomm = GRID->row_comm; Rmsgid = 3001;
   Ccomm = GRID->col_comm; Cmsgid = 3001 + 1;
   GridIsNot1xQ = ( nprow > 1 ); GridIsNotPx1 = ( npcol > 1 );



   { if( ( (0) >= 0 ) && ( (nprow) > 1 ) ) { int inb__, mydist__, n__, nblk__, quot__, src__; if( ( inb__ = (nb) - (0) ) <= 0 ) { nblk__ = (-inb__) / (nb) + 1; src__ = (0) + nblk__; src__ -= ( src__ / (nprow) ) * (nprow); inb__ += nblk__*(nb); if( ( n__ = (n) - inb__ ) <= 0 ) { if( (myrow) == src__ ) Anp = (n); else Anp = 0; } else { if( ( mydist__ = (myrow) - src__ ) < 0 ) mydist__ += (nprow); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - (quot__ = (nblk__ / (nprow))) * (nprow); if( mydist__ < 0 ) { if( (myrow) != src__ ) Anp = (nb) + (nb) * quot__; else Anp = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { Anp = (nb) * quot__; } else { if( (myrow) != src__ ) Anp = n__ +(nb)+(nb)*(quot__ - nblk__); else Anp = (n)+ (nb)*(quot__ - nblk__); } } } else { if( ( n__ = (n) - inb__ ) <= 0 ) { if( (myrow) == (0) ) Anp = (n); else Anp = 0; } else { if( ( mydist__ = (myrow) - (0) ) < 0 ) mydist__ += (nprow); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - ( quot__ = (nblk__ / (nprow)) )*(nprow); if( mydist__ < 0 ) { if( (myrow) != (0) ) Anp = (nb) + (nb) * quot__; else Anp = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { Anp = (nb) * quot__; } else { if( (myrow) != (0) ) Anp = n__ +(nb)+(nb)*(quot__ - nblk__); else Anp = (n)+ (nb)*(quot__ - nblk__); } } } } else { Anp = (n); } };
   { if( ( (0) >= 0 ) && ( (npcol) > 1 ) ) { int inb__, mydist__, n__, nblk__, quot__, src__; if( ( inb__ = (nb) - (0) ) <= 0 ) { nblk__ = (-inb__) / (nb) + 1; src__ = (0) + nblk__; src__ -= ( src__ / (npcol) ) * (npcol); inb__ += nblk__*(nb); if( ( n__ = (n) - inb__ ) <= 0 ) { if( (mycol) == src__ ) Anq = (n); else Anq = 0; } else { if( ( mydist__ = (mycol) - src__ ) < 0 ) mydist__ += (npcol); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - (quot__ = (nblk__ / (npcol))) * (npcol); if( mydist__ < 0 ) { if( (mycol) != src__ ) Anq = (nb) + (nb) * quot__; else Anq = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { Anq = (nb) * quot__; } else { if( (mycol) != src__ ) Anq = n__ +(nb)+(nb)*(quot__ - nblk__); else Anq = (n)+ (nb)*(quot__ - nblk__); } } } else { if( ( n__ = (n) - inb__ ) <= 0 ) { if( (mycol) == (0) ) Anq = (n); else Anq = 0; } else { if( ( mydist__ = (mycol) - (0) ) < 0 ) mydist__ += (npcol); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - ( quot__ = (nblk__ / (npcol)) )*(npcol); if( mydist__ < 0 ) { if( (mycol) != (0) ) Anq = (nb) + (nb) * quot__; else Anq = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { Anq = (nb) * quot__; } else { if( (mycol) != (0) ) Anq = n__ +(nb)+(nb)*(quot__ - nblk__); else Anq = (n)+ (nb)*(quot__ - nblk__); } } } } else { Anq = (n); } };
   ...
   Aptr = (double *)(A); XC = ( (Aptr) + (0) + (Anq)*(lda) );
   { if( ( (n) >= (nb) ) && ( (0) >= 0 ) && ( (npcol) > 1 ) ) { Bcol = (0) + 1 + ( (n)-(nb) ) / (nb); Bcol -= ( Bcol / (npcol) ) * (npcol); } else { Bcol = (0); } };
   ...
   Rmsgid = ( Rmsgid + 2 >
              4000 ? 3001 : Rmsgid + 2 );
   if( mycol != Alcol )
   { for( tmp1=0; tmp1 < Anp; tmp1++ ) XC[tmp1] = 0.0; }



   n1 = ( npcol - 1 ) * nb; n1 = ( ( (n1) > (nb) ) ? (n1) : (nb) );
   if( Anp > 0 )
   {
      W = (double*)malloc( ( ( (n1) < (Anp) ) ? (n1) : (Anp) ) * sizeof( double ) );
      if( W == ((void *)0) )
      { HPL_pabort( 164, "HPL_pdtrsv", "Memory allocation failed" ); }
      Wfr = 1;
   }

   Anpprev = Anp; Xdprev = XR; Aprev = Aptr = ( (Aptr) + (0) + (Anq)*(lda) );
   tmp1 = n - kb; tmp1 -= ( tmp2 = ( ( (tmp1) < (n1) ) ? (tmp1) : (n1) ) );
   { if( ( (0) >= 0 ) && ( (nprow) > 1 ) ) { int inb__, mydist__, n__, nblk__, quot__, src__; if( ( inb__ = (nb) - (( ( (0) > (tmp1) ) ? (0) : (tmp1) )) ) <= 0 ) { nblk__ = (-inb__) / (nb) + 1; src__ = (0) + nblk__; src__ -= ( src__ / (nprow) ) * (nprow); inb__ += nblk__*(nb); if( ( n__ = (tmp2) - inb__ ) <= 0 ) { if( (myrow) == src__ ) n1pprev = (tmp2); else n1pprev = 0; } else { if( ( mydist__ = (myrow) - src__ ) < 0 ) mydist__ += (nprow); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - (quot__ = (nblk__ / (nprow))) * (nprow); if( mydist__ < 0 ) { if( (myrow) != src__ ) n1pprev = (nb) + (nb) * quot__; else n1pprev = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { n1pprev = (nb) * quot__; } else { if( (myrow) != src__ ) n1pprev = n__ +(nb)+(nb)*(quot__ - nblk__); else n1pprev = (tmp2)+ (nb)*(quot__ - nblk__); } } } else { if( ( n__ = (tmp2) - inb__ ) <= 0 ) { if( (myrow) == (0) ) n1pprev = (tmp2); else n1pprev = 0; } else { if( ( mydist__ = (myrow) - (0) ) < 0 ) mydist__ += (nprow); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - ( quot__ = (nblk__ / (nprow)) )*(nprow); if( mydist__ < 0 ) { if( (myrow) != (0) ) n1pprev = (nb) + (nb) * quot__; else n1pprev = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { n1pprev = (nb) * quot__; } else { if( (myrow) != (0) ) n1pprev = n__ +(nb)+(nb)*(quot__ - nblk__); else n1pprev = (tmp2)+ (nb)*(quot__ - nblk__); } } } } else { n1pprev = (tmp2); } };
   ...
   if( mycol == Alcol )
   {
      ...
      if( myrow == Alrow )
      {
         cblas_dtrsv( HplColumnMajor, HplUpper, HplNoTrans, HplNonUnit,
                    kb, Aptr+Anp, lda, XC+Anp, 1 );
         cblas_dcopy( kb, XC+Anp, 1, Xd, 1 );
      }
   }

   rowprev = Alrow; Alrow = ( ((Alrow)!=0) ? (Alrow)-1 : (nprow)-1 );
   colprev = Alcol; Alcol = ( ((Alcol)!=0) ? (Alcol)-1 : (npcol)-1 );
   kbprev = kb; n -= kb;
   tmp1 = n - ( kb = nb ); tmp1 -= ( tmp2 = ( ( (tmp1) < (n1) ) ? (tmp1) : (n1) ) );
   { if( ( (0) >= 0 ) && ( (nprow) > 1 ) ) { int inb__, mydist__, n__, nblk__, quot__, src__; if( ( inb__ = (nb) - (( ( (0) > (tmp1) ) ? (0) : (tmp1) )) ) <= 0 ) { nblk__ = (-inb__) / (nb) + 1; src__ = (0) + nblk__; src__ -= ( src__ / (nprow) ) * (nprow); inb__ += nblk__*(nb); if( ( n__ = (tmp2) - inb__ ) <= 0 ) { if( (myrow) == src__ ) n1p = (tmp2); else n1p = 0; } else { if( ( mydist__ = (myrow) - src__ ) < 0 ) mydist__ += (nprow); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - (quot__ = (nblk__ / (nprow))) * (nprow); if( mydist__ < 0 ) { if( (myrow) != src__ ) n1p = (nb) + (nb) * quot__; else n1p = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { n1p = (nb) * quot__; } else { if( (myrow) != src__ ) n1p = n__ +(nb)+(nb)*(quot__ - nblk__); else n1p = (tmp2)+ (nb)*(quot__ - nblk__); } } } else { if( ( n__ = (tmp2) - inb__ ) <= 0 ) { if( (myrow) == (0) ) n1p = (tmp2); else n1p = 0; } else { if( ( mydist__ = (myrow) - (0) ) < 0 ) mydist__ += (nprow); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - ( quot__ = (nblk__ / (nprow)) )*(nprow); if( mydist__ < 0 ) { if( (myrow) != (0) ) n1p = (nb) + (nb) * quot__; else n1p = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { n1p = (nb) * quot__; } else { if( (myrow) != (0) ) n1p = n__ +(nb)+(nb)*(quot__ - nblk__); else n1p = (tmp2)+ (nb)*(quot__ - nblk__); } } } } else { n1p = (tmp2); } };
   ...
   while( n > 0 )
   {
      ...
      if( mycol == colprev )
      {
         ...
         {
            if( GridIsNot1xQ )
               (void) HPL_send( Xdprev, kbprev, ( ((myrow)!=0) ? (myrow)-1 : (nprow)-1 ),
                                Cmsgid, Ccomm );
         }
         else
         {
            (void) HPL_recv( Xdprev, kbprev, ( ((myrow) != (nprow)-1) ? (myrow) + 1 : 0 ),
                             Cmsgid, Ccomm );
         }
         ...
         if( n1pprev > 0 )
         {
            ...
            cblas_dgemv( HplColumnMajor, HplNoTrans, n1pprev, kbprev,
                       -1.0, Aprev+tmp1, lda, Xdprev, 1, 1.0,
                       XC+tmp1, 1 );
            if( GridIsNotPx1 )
         ...
         if( ( myrow != rowprev ) &&
             ( myrow != ( ((rowprev) != (nprow)-1) ? (rowprev) + 1 : 0 ) ) )
            (void) HPL_send( Xdprev, kbprev, ( ((myrow)!=0) ? (myrow)-1 : (nprow)-1 ),
                             Cmsgid, Ccomm );
      }
      else if( mycol == Alcol )
      {
         ...
         if( n1pprev > 0 )
         {
            ...
            cblas_daxpy( n1pprev, 1.0, W, 1, XC+Anpprev-n1pprev, 1 );
         }
      }
      ...
      if( ( mycol == Alcol ) && ( myrow == Alrow ) )
      {
         cblas_dtrsv( HplColumnMajor, HplUpper, HplNoTrans, HplNonUnit,
                    kb, Aptr+Anp, lda, XC+Anp, 1 );
         cblas_dcopy( kb, XC+Anp, 1, XR+Anq, 1 );
      }



      if( ( mycol == colprev ) && ( ( tmp1 = Anpprev - n1pprev ) > 0 ) )
         cblas_dgemv( HplColumnMajor, HplNoTrans, tmp1, kbprev, -1.0,
                    Aprev, lda, Xdprev, 1, 1.0, XC, 1 );
      ...
      Alrow = ( ((Alrow)!=0) ? (Alrow)-1 : (nprow)-1 ); Alcol = ( ((Alcol)!=0) ? (Alcol)-1 : (npcol)-1 );
      tmp1 = n - ( kb = nb ); tmp1 -= ( tmp2 = ( ( (tmp1) < (n1) ) ? (tmp1) : (n1) ) );
      { if( ( (0) >= 0 ) && ( (nprow) > 1 ) ) { int inb__, mydist__, n__, nblk__, quot__, src__; if( ( inb__ = (nb) - (( ( (0) > (tmp1) ) ? (0) : (tmp1) )) ) <= 0 ) { nblk__ = (-inb__) / (nb) + 1; src__ = (0) + nblk__; src__ -= ( src__ / (nprow) ) * (nprow); inb__ += nblk__*(nb); if( ( n__ = (tmp2) - inb__ ) <= 0 ) { if( (myrow) == src__ ) n1p = (tmp2); else n1p = 0; } else { if( ( mydist__ = (myrow) - src__ ) < 0 ) mydist__ += (nprow); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - (quot__ = (nblk__ / (nprow))) * (nprow); if( mydist__ < 0 ) { if( (myrow) != src__ ) n1p = (nb) + (nb) * quot__; else n1p = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { n1p = (nb) * quot__; } else { if( (myrow) != src__ ) n1p = n__ +(nb)+(nb)*(quot__ - nblk__); else n1p = (tmp2)+ (nb)*(quot__ - nblk__); } } } else { if( ( n__ = (tmp2) - inb__ ) <= 0 ) { if( (myrow) == (0) ) n1p = (tmp2); else n1p = 0; } else { if( ( mydist__ = (myrow) - (0) ) < 0 ) mydist__ += (nprow); nblk__ = n__ / (nb) + 1; mydist__ -= nblk__ - ( quot__ = (nblk__ / (nprow)) )*(nprow); if( mydist__ < 0 ) { if( (myrow) != (0) ) n1p = (nb) + (nb) * quot__; else n1p = inb__ + (nb) * quot__; } else if( mydist__ > 0 ) { n1p = (nb) * quot__; } else { if( (myrow) != (0) ) n1p = n__ +(nb)+(nb)*(quot__ - nblk__); else n1p = (tmp2)+ (nb)*(quot__ - nblk__); } } } } else { n1p = (tmp2); } };

      Rmsgid = ( Rmsgid+2 > 4000 ?
                 3001 : Rmsgid+2 );
      Cmsgid = ( Cmsgid+2 > 4000 ?
                 3001 +1 : Cmsgid+2 );
   }
