...
# 204 "../HPL_rollT.c"
         if( ierr == 0 )
            ierr = MPI_Irecv( ( (U) + (0) + (ibufR)*(LDU) ), lengthR*LDU,
                                ((MPI_Datatype)0x4c00080b), partner, Cmsgid, comm, &request );
...
# 233 "../HPL_rollT.c"
         if( ierr == 0 )
            ierr = MPI_Send( ( (U) + (0) + (ibufS)*(LDU) ), lengthS*LDU,
                               ((MPI_Datatype)0x4c00080b), partner, Cmsgid, comm );
