# 1 "../HPL_pdpanel_init.c"
# 1 "/home/westwind/mpibench/1hpl/hpl-1.0/src/panel/crestBranch//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "../HPL_pdpanel_init.c"
# 50 "../HPL_pdpanel_init.c"
...
# 86 "../HPL_pdpanel_init.c"
{
# 141 "../HPL_pdpanel_init.c"
   size_t dalign;
   ...
   PANEL->A = ( ((double *)(A->A)) + (ii) + (jj)*(A->ld) );



   PANEL->WORK = ((void *)0); PANEL->L2 = ((void *)0); PANEL->L1 = ((void *)0);
   PANEL->DPIV = ((void *)0); PANEL->DINFO = ((void *)0); PANEL->U = ((void *)0);
   PANEL->IWORK = ((void *)0);
...
# 204 "../HPL_pdpanel_init.c"
   ...
   if( npcol == 1 )
   {
      ...
      if( nprow > 1 )
      { nu = nq - JB; lwork += JB * ( ( (0) > (nu) ) ? (0) : (nu) ); }

      if( !( PANEL->WORK = (void *)malloc( lwork * sizeof( double ) ) ) )
      {
         HPL_pabort( 214, "HPL_pdpanel_init",
      ...
      PANEL->ldl2 = A->ld;
      PANEL->L1 = (double *)( ( ( (size_t)(PANEL->WORK)+(dalign)-1 ) / (dalign) ) * (dalign) );
      PANEL->DPIV = PANEL->L1 + JB * JB;
      PANEL->DINFO = PANEL->DPIV + JB; *(PANEL->DINFO) = 0.0;
      PANEL->U = ( nprow > 1 ? PANEL->DINFO + 1: ((void *)0) );
   }
   else
   {
      ml2 = ( myrow == icurrow ? mp - JB : mp ); ml2 = ( ( (0) > (ml2) ) ? (0) : (ml2) );
      ...
      if( !( PANEL->WORK = (void *)malloc( lwork * sizeof( double ) ) ) )
      {
         HPL_pabort( 245, "HPL_pdpanel_init",
                     "Memory allocation failed" );
      }
# 257 "../HPL_pdpanel_init.c"
      ...
      {
         PANEL->L2 = (double *)( ( ( (size_t)(PANEL->WORK)+(dalign)-1 ) / (dalign) ) * (dalign) );
         PANEL->ldl2 = ( ( (1) > (ml2) ) ? (1) : (ml2) );
...
# 330 "../HPL_pdpanel_init.c"
   ...
   {
      itmp1 = (JB << 1); lwork = nprow + 1; itmp1 = ( ( (itmp1) > (lwork) ) ? (itmp1) : (lwork) );
      lwork = 4 + (9 * JB) + (3 * nprow) + itmp1;
   }

   PANEL->IWORK = (int *)malloc( lwork * sizeof( int ) );

   if( PANEL->IWORK == ((void *)0) )
