...
# 146 "../HPL_pdrpanllT.c"
   ...
   do
   {
      ...
      cblas_dtrsm( HplColumnMajor, HplRight, HplUpper, HplNoTrans,
                 HplUnit, jb, jj, 1.0, L1ptr, n0, ( (L1ptr) + (jj) + (0)*(n0) )
                            , n0 );
# 219 "../HPL_pdrpanllT.c"
      cblas_dgemm( HplColumnMajor, HplNoTrans, HplTrans, m, jb,
                 jj, -1.0, ( (Aptr) + (ii) + (0)*(lda) ), lda,
                 ( (L1ptr) + (jj) + (0)*(n0) ), n0, 1.0,
                 ( (Aptr) + (ii) + (jj)*(lda) ), lda );
