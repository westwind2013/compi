...
# 146 "../HPL_pdrpancrT.c"
   ...
   if( curr != 0 ) Aptr = ( (A) + (ICOFF) + (ICOFF)*(lda) );
   else Aptr = ( (A) + (0) + (ICOFF)*(lda) );
   ...
   do
   {
      n -= jb; ioff = ICOFF + jj;
# 216 "../HPL_pdrpancrT.c"
      cblas_dgemm( HplColumnMajor, HplNoTrans, HplTrans, m, jb, jj,
                 -1.0, ( (Aptr) + (ii) + (0)*(lda) ), lda, ( (L1ptr) + (jj) + (0)*(n0) )
                            , n0, 1.0, ( (Aptr) + (ii) + (jj)*(lda) ),
                 lda );
      ...
      {
# 258 "../HPL_pdrpancrT.c"
         cblas_dgemm( HplColumnMajor, HplNoTrans, HplNoTrans, n, jb,
                    jj, -1.0, ( (L1ptr) + (jj+jb) + (0)*(n0) ), n0,
                    ( (L1ptr) + (0) + (jj)*(n0) ), n0, 1.0,
                    ( (L1ptr) + (jj+jb) + (jj)*(n0) ), n0 );

         cblas_dtrsm( HplColumnMajor, HplRight, HplUpper, HplNoTrans,
                    HplUnit, n, jb, 1.0, ( (L1ptr) + (jj) + (jj)*(n0) )
                        , n0, ( (L1ptr) + (jj+jb) + (jj)*(n0) ), n0 );
      }
      ...
      if( curr != 0 )
      {
         HPL_dlatcpy( ioff, jb, ( (L1) + (ioff) + (0)*(n0) ), n0,
                      ( (A) + (0) + (ioff)*(lda) ), lda );
         ii += jb; m -= jb;
      }
      jj += jb; jb = ( ( (n) < (nb) ) ? (n) : (nb) );
