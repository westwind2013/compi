...
# 146 "../HPL_pdrpancrN.c"
   ...
   do
   {
      n -= jb; ioff = ICOFF + jj;
# 216 "../HPL_pdrpancrN.c"
      cblas_dgemm( HplColumnMajor, HplNoTrans, HplNoTrans, m, jb, jj,
                 -1.0, ( (Aptr) + (ii) + (0)*(lda) ), lda, ( (L1ptr) + (0) + (jj)*(n0) )
      ...
      {
# 258 "../HPL_pdrpancrN.c"
         cblas_dgemm( HplColumnMajor, HplNoTrans, HplNoTrans, jb, n,
                    jj, -1.0, ( (L1ptr) + (jj) + (0)*(n0) ), n0,
                    ( (L1ptr) + (0) + (jj+jb)*(n0) ), n0, 1.0,
                    ( (L1ptr) + (jj) + (jj+jb)*(n0) ), n0 );

         cblas_dtrsm( HplColumnMajor, HplLeft, HplLower, HplNoTrans,
                    HplUnit, jb, n, 1.0, ( (L1ptr) + (jj) + (jj)*(n0) )
                        , n0, ( (L1ptr) + (jj) + (jj+jb)*(n0) ), n0 );
      }
      ...
      if( curr != 0 )
      {
         HPL_dlacpy( ioff, jb, ( (L1) + (0) + (ioff)*(n0) ), n0,
                     ( (A) + (0) + (ioff)*(lda) ), lda );
         ii += jb; m -= jb;
      }
      jj += jb; jb = ( ( (n) < (nb) ) ? (n) : (nb) );
