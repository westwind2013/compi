# 1 "../HPL_timer.c"
# 1 "/home/westwind/mpibench/1hpl/hpl-1.0/testing/timer/crestBranch//"
# 1 "<built-in>"
# 1 "<command-line>"
...
static double HPL_timer_cpusec [64],
                              HPL_timer_cpustart [64],
                              HPL_timer_wallsec [64],
                              HPL_timer_wallstart[64];
...

{
   ...
   for( i = 0; i < 64; i++ )
   {
      HPL_timer_cpusec [i] = HPL_timer_wallsec [i] = 0.0;
      HPL_timer_cpustart[i] = HPL_timer_wallstart[i] = 5.0;
   }
