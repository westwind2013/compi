...
# 271 "../HPL_pdinfo.c"
   ...
   if( rank == 0 )
   {
      ...
      if( ( infp = fopen( "HPL.dat", "r" ) ) == ((void *)0) )
      {
         HPL_pwarn( stderr, 299, "HPL_pdinfo",
                    "cannot open file HPL.dat" );
         error = 1; goto label_error;
      }

      (void) fgets( line, 256 - 2, infp );
      (void) fgets( auth, 256 - 2, infp );
      ...
      else if( ( TEST->outfp = fopen( file, "w" ) ) == ((void *)0) )
      {
         HPL_pwarn( stderr, 318, "HPL_pdinfo", "cannot open file %s.",
                    file );
         error = 1; goto label_error;
      }
      ...
      if( ( *NS < 1 ) || ( *NS > 20 ) )
      {
         HPL_pwarn( stderr, 331, "HPL_pdinfo", "%s %d",
                    "Number of values of N is less than 1 or greater than",
                    20 );
         error = 1; goto label_error;
      }

      (void) fgets( line, 256 - 2, infp ); lineptr = line;
      for( i = 0; i < *NS; i++ )
      {
         ...
         {
            HPL_pwarn( stderr, 344, "HPL_pdinfo",
      ...
      if( ( *NBS < 1 ) || ( *NBS > 20 ) )
      {
         HPL_pwarn( stderr, 356, "HPL_pdinfo", "%s %s %d",
      ...
      for( i = 0; i < *NBS; i++ )
      {
         ...
         {
            HPL_pwarn( stderr, 369, "HPL_pdinfo",
      ...
      *PMAPPIN = ( atoi( num ) == 1 ? HPL_COLUMN_MAJOR : HPL_ROW_MAJOR );
      ...
      if( ( *NPQS < 1 ) || ( *NPQS > 20 ) )
      {
         HPL_pwarn( stderr, 385, "HPL_pdinfo", "%s %s %d",
      ...
      for( i = 0; i < *NPQS; i++ )
      {
         ...
         if( ( P[ i ] = atoi( num ) ) < 1 )
         {
            HPL_pwarn( stderr, 398, "HPL_pdinfo",
      ...
      for( i = 0; i < *NPQS; i++ )
      {
         ...
         if( ( Q[ i ] = atoi( num ) ) < 1 )
         {
            HPL_pwarn( stderr, 410, "HPL_pdinfo",
      ...
      maxp = 0;
      for( i = 0; i < *NPQS; i++ )
      { nprocs = P[i] * Q[i]; maxp = ( ( (maxp) > (nprocs) ) ? (maxp) : (nprocs) ); }
      if( maxp > size )
      {
         HPL_pwarn( stderr, 423, "HPL_pdinfo",
      ...
      if( ( *NPFS < 1 ) || ( *NPFS > 20 ) )
      {
         HPL_pwarn( stderr, 439, "HPL_pdinfo", "%s %s %d",
      ...
      if( ( *NBMS < 1 ) || ( *NBMS > 20 ) )
      {
         HPL_pwarn( stderr, 461, "HPL_pdinfo", "%s %s %d",
      ...
      for( i = 0; i < *NBMS; i++ )
      {
         ...
         if( ( NBM[ i ] ) < 1 )
         {
            HPL_pwarn( stderr, 473, "HPL_pdinfo",
      ...
      if( ( *NDVS < 1 ) || ( *NDVS > 20 ) )
      {
         HPL_pwarn( stderr, 485, "HPL_pdinfo", "%s %s %d",
      ...
      for( i = 0; i < *NDVS; i++ )
      {
         ...
         {
            HPL_pwarn( stderr, 497, "HPL_pdinfo",
      ...
      if( ( *NRFS < 1 ) || ( *NRFS > 20 ) )
      {
         HPL_pwarn( stderr, 509, "HPL_pdinfo", "%s %s %d",
      ...
      if( ( *NTPS < 1 ) || ( *NTPS > 20 ) )
      {
         HPL_pwarn( stderr, 531, "HPL_pdinfo", "%s %s %d",
      ...
      if( ( *NDHS < 1 ) || ( *NDHS > 20 ) )
      {
         HPL_pwarn( stderr, 556, "HPL_pdinfo", "%s %s %d",
      ...
      for( i = 0; i < *NDHS; i++ )
      {
         ...
         {
            HPL_pwarn( stderr, 569, "HPL_pdinfo",
...
label_error:
   ...
   {
      if( rank == 0 )
         HPL_pwarn( stderr, 628, "HPL_pdinfo",
   ...
   TEST->epsil = HPL_pdlamch( ((MPI_Comm)0x44000000), HPL_MACH_EPS );
   ...
   (void) HPL_broadcast( (void *)iwork, 15, HPL_INT, 0, ((MPI_Comm)0x44000000) );
   if( rank != 0 )
   {
   ...
   if( rank == 0 )
   {
      ...
      HPL_fprintf( TEST->outfp, "\nN      :" );
      for( i = 0; i < ( ( (8) < (*NS) ) ? (8) : (*NS) ); i++ )
         HPL_fprintf( TEST->outfp, "%8d ", N[i] );
      if( *NS > 8 )
      {
         HPL_fprintf( TEST->outfp, "\n        " );
         for( i = 8; i < ( ( (16) < (*NS) ) ? (16) : (*NS) ); i++ )
            HPL_fprintf( TEST->outfp, "%8d ", N[i] );
         if( *NS > 16 )
         {
            HPL_fprintf( TEST->outfp, "\n        " );
      ...
      HPL_fprintf( TEST->outfp, "\nNB     :" );
      for( i = 0; i < ( ( (8) < (*NBS) ) ? (8) : (*NBS) ); i++ )
         HPL_fprintf( TEST->outfp, "%8d ", NB[i] );
      if( *NBS > 8 )
      {
         HPL_fprintf( TEST->outfp, "\n        " );
         for( i = 8; i < ( ( (16) < (*NBS) ) ? (16) : (*NBS) ); i++ )
            HPL_fprintf( TEST->outfp, "%8d ", NB[i] );
         if( *NBS > 16 )
         {
            HPL_fprintf( TEST->outfp, "\n        " );
      ...
      HPL_fprintf( TEST->outfp, "\nP      :" );
      for( i = 0; i < ( ( (8) < (*NPQS) ) ? (8) : (*NPQS) ); i++ )
         HPL_fprintf( TEST->outfp, "%8d ", P[i] );
      if( *NPQS > 8 )
      {
         HPL_fprintf( TEST->outfp, "\n        " );
         for( i = 8; i < ( ( (16) < (*NPQS) ) ? (16) : (*NPQS) ); i++ )
            HPL_fprintf( TEST->outfp, "%8d ", P[i] );
         if( *NPQS > 16 )
         {
            HPL_fprintf( TEST->outfp, "\n        " );
      ...
      HPL_fprintf( TEST->outfp, "\nNBMIN  :" );
      for( i = 0; i < ( ( (8) < (*NBMS) ) ? (8) : (*NBMS) ); i++ )
         HPL_fprintf( TEST->outfp, "%8d ", NBM[i] );
      if( *NBMS > 8 )
      {
         HPL_fprintf( TEST->outfp, "\n        " );
         for( i = 8; i < ( ( (16) < (*NBMS) ) ? (16) : (*NBMS) ); i++ )
            HPL_fprintf( TEST->outfp, "%8d ", NBM[i] );
         if( *NBMS > 16 )
         {
            HPL_fprintf( TEST->outfp, "\n        " );
      ...
      HPL_fprintf( TEST->outfp, "\nNDIV   :" );
      for( i = 0; i < ( ( (8) < (*NDVS) ) ? (8) : (*NDVS) ); i++ )
         HPL_fprintf( TEST->outfp, "%8d ", NDV[i] );
      if( *NDVS > 8 )
      {
         HPL_fprintf( TEST->outfp, "\n        " );
         for( i = 8; i < ( ( (16) < (*NDVS) ) ? (16) : (*NDVS) ); i++ )
            HPL_fprintf( TEST->outfp, "%8d ", NDV[i] );
         if( *NDVS > 16 )
         {
            HPL_fprintf( TEST->outfp, "\n        " );
      ...
      HPL_fprintf( TEST->outfp, "\nDEPTH  :" );
      for( i = 0; i < ( ( (8) < (*NDHS) ) ? (8) : (*NDHS) ); i++ )
         HPL_fprintf( TEST->outfp, "%8d ", DH[i] );
      if( *NDHS > 8 )
      {
         HPL_fprintf( TEST->outfp, "\n        " );
         for( i = 8; i < ( ( (16) < (*NDHS) ) ? (16) : (*NDHS) ); i++ )
            HPL_fprintf( TEST->outfp, "%8d ", DH[i] );
         if( *NDHS > 16 )
         {
            HPL_fprintf( TEST->outfp, "\n        " );
