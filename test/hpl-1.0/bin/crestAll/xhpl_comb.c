...
#line 70 "/home/westwind/mpibench/1hpl/hpl-1.0/include/hpl_ptest.h"
struct HPL_S_test {
   double epsil ;
   double thrsh ;
   FILE *outfp ;
...
#line 63 "/home/westwind/mpibench/1hpl/hpl-1.0/include/hpl_blas.h"
enum HPL_UPLO {
    HplUpper = 121,
    HplLower = 122
} ;
...
#line 109 "/home/westwind/mpibench/1hpl/hpl-1.0/include/hpl_ptest.h"
...
#line 682
    while (i < *NPFS) {
#line 684
      if ((unsigned int )*(PF + i) == 301U) {
#line 684
        *(iwork + j) = 0;
      } else
#line 685
      if ((unsigned int )*(PF + i) == 302U) {
#line 685
        *(iwork + j) = 1;
      } else
#line 686
      if ((unsigned int )*(PF + i) == 303U) {
#line 686
        *(iwork + j) = 2;
      }
#line 687
...
#line 691
    while (i < *NRFS) {
#line 693
      if ((unsigned int )*(RF + i) == 301U) {
#line 693
        *(iwork + j) = 0;
      } else
#line 694
      if ((unsigned int )*(RF + i) == 302U) {
#line 694
        *(iwork + j) = 1;
      } else
#line 695
      if ((unsigned int )*(RF + i) == 303U) {
#line 695
        *(iwork + j) = 2;
      }
#line 696
...
#line 698
    while (i < *NTPS) {
#line 700
      if ((unsigned int )*(TP + i) == 401U) {
#line 700
        *(iwork + j) = 0;
      } else
#line 701
      if ((unsigned int )*(TP + i) == 402U) {
#line 701
        *(iwork + j) = 1;
      } else
#line 702
      if ((unsigned int )*(TP + i) == 403U) {
#line 702
        *(iwork + j) = 2;
      } else
#line 703
      if ((unsigned int )*(TP + i) == 404U) {
#line 703
        *(iwork + j) = 3;
      } else
#line 704
      if ((unsigned int )*(TP + i) == 405U) {
#line 704
        *(iwork + j) = 4;
      } else
#line 705
      if ((unsigned int )*(TP + i) == 406U) {
#line 705
        *(iwork + j) = 5;
      }
#line 706
...
#line 124 "/home/westwind/mpibench/1hpl/hpl-1.0/include/hpl_blas.h"
...
#line 81 "/home/westwind/mpibench/1hpl/hpl-1.0/include/hpl_ptimer.h"
...
#line 132 "../HPL_pdtest.c"
static int first  =    1;
#line 53 "../HPL_pdtest.c"
void HPL_pdtest(HPL_T_test *TEST , HPL_T_grid *GRID , HPL_T_palg *ALGO , int const   N ,
                int const   NB ) 
{ 
  HPL_T_pmat mat ;
...
#line 344
    cblas_dgemv((enum HPL_ORDER  const  )102, (enum HPL_TRANS  const  )111, (int const   )mat.mp,
                (int const   )nq, (double const   )(- 1.0), (double const   *)mat.A,
                (int const   )mat.ld, (double const   *)mat.X, (int const   )1, (double const   )0.0,
                Bptr, (int const   )1);
  } else {
#line 347
    ii = 0;
...
#line 998 "//usr/include/mpich/mpi.h"
