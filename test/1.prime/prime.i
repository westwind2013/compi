...
# 1 "/home/westwind/myInstall/crest.mpi/bin/../include/crest.h" 1
# 136 "/home/westwind/myInstall/crest.mpi/bin/../include/crest.h"
 typedef enum {
...
# 176 "/home/westwind/myInstall/crest.mpi/bin/../include/crest.h"
...
# 203 "/home/westwind/myInstall/crest.mpi/bin/../include/crest.h"
...
extern void __CrestIntRank(int* x) __attribute__((crest_skip));
# 8 "prime.c" 2
...
# 40 "prime.c"
{
 ...
 ierr = MPI_Comm_size ( ((MPI_Comm)0x44000000), &p );



 ierr = MPI_Comm_rank ( ((MPI_Comm)0x44000000), &id );
 ...
 while ( n <= n_hi )
 {
  ...
  ierr = MPI_Bcast ( &n, 1, ((MPI_Datatype)0x4c000405), 0, ((MPI_Comm)0x44000000) );

  primes_part = prime_number ( n, id, p );

  ierr = MPI_Reduce ( &primes_part, &primes, 1, ((MPI_Datatype)0x4c000405), (MPI_Op)(0x58000003), 0,
    ((MPI_Comm)0x44000000) );
