...
# 48 "mpi_comm.c"
{
  ...
  MPI_Comm_group ( ((MPI_Comm)0x44000000), &world_group_id );
  ...
  MPI_Comm_create ( ((MPI_Comm)0x44000000), even_group_id, &even_comm_id );
  int size1;
  ...
  MPI_Comm_create ( ((MPI_Comm)0x44000000), odd_group_id, &odd_comm_id );
  int size2;
  ...
  if ( even_id != -1 )
  {
    MPI_Reduce ( &id, &even_id_sum, 1, ((MPI_Datatype)0x4c000405), (MPI_Op)(0x58000003), 0, even_comm_id );
  }
  if ( even_id == 0 )
  {
  ...
  if ( odd_id != -1 )
  {
    MPI_Reduce ( &id, &odd_id_sum, 1, ((MPI_Datatype)0x4c000405), (MPI_Op)(0x58000003), 0, odd_comm_id );
  }
  if ( odd_id == 0 )
  {
